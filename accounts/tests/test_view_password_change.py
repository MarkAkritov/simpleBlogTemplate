...
class SuccessfulPasswordChangeTests(PasswordChangeTestCase):
    ...
    def test_password_changed(self):
        """
        Refresh the user instance from database to get the password hash
        updated by the change password view.
        """
    ...
    def test_user_authentication(self):
        """
        Create a new request to an arbitrary page. The resulting response should now have an
        `user` to its context, after a successful sign up.
        """
...
class InvalidPasswordChangeTests(PasswordChangeTestCase):
    ...
    def test_didnt_change_password(self):
        """
        Refresh the user instance from the database to make sure we have the latest news.
        """
        self.user.refresh_from_db()
